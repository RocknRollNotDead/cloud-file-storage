...
Изначальная версия фронтенда нацелена на поиск в корне всегда, независимо откуда применяется запрос.
Я сделал по-другому - поиск только в той папке, откуда идёт поиск.


## Тесты

На мой взгляд покрытие >95% сценариев, все тесты пройдены
